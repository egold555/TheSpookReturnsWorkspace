...
public class HeightMapTerrain extends Terrain{
	...
	public HeightMapTerrain(int gridX, int gridZ, TerrainTexturePack texturePack, int blendMap, String heightMap) {
	...
	protected RawModel generateTerrain(String heightMap){
		...
		try {
			...
			GELog.error(e, "Cound not find HeightMap '" + heightMap + "'.");
		}
