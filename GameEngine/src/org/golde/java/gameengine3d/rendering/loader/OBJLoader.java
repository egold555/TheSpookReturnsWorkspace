package org.golde.java.gameengine3d.rendering.loader;
...
public class OBJLoader {
	...
	public RawModel loadObjectModel(String fileName) {
		FileReader fr = null;
		try {
			fr = new FileReader(new File("res/" + fileName + ".obj"));
		} catch (FileNotFoundException e) {
			GELog.error("Model 'res/" + fileName + ".obj' does not exist! Using Default Model");
			return loadObjectModel("models/default/noModel");
		...
		try {
			...
			GELog.error(e, "Failed to loadObjectModel: " + fileName);
		}
	...
	private void prossessVertex(int index, String[] vertexData, List<Vector3f> vertices, List<Vector2f> textures, List<Vector3f> normals, float[] vertexArray, float[] textureArray, float[] normalsArray) {
